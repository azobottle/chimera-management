...
import type { GetAllUsersError, GetAllUsersResponse, UpdateUserData, UpdateUserError, UpdateUserResponse, CreateUserData, CreateUserError, CreateUserResponse, GetAllProductCatesError, GetAllProductCatesResponse, UpdateProductCateData, UpdateProductCateError, UpdateProductCateResponse, CreateProductCateData, CreateProductCateError, CreateProductCateResponse, GetAllProductsError, GetAllProductsResponse, UpdateProductData, UpdateProductError, UpdateProductResponse, CreateProductData, CreateProductError, CreateProductResponse, GetAllProductOptionsError, GetAllProductOptionsResponse, UpdateProductOptionData, UpdateProductOptionError, UpdateProductOptionResponse, CreateProductOptionData, CreateProductOptionError, CreateProductOptionResponse, GetAllFixDeliveryInfosError, GetAllFixDeliveryInfosResponse, UpdateFixDeliveryInfoData, UpdateFixDeliveryInfoError, UpdateFixDeliveryInfoResponse, CreateFixDeliveryInfoData, CreateFixDeliveryInfoError, CreateFixDeliveryInfoResponse, GetAllCouponsError, GetAllCouponsResponse, UpdateCouponData, UpdateCouponError, UpdateCouponResponse, CreateCouponData, CreateCouponError, CreateCouponResponse, GetAllActivitiesError, GetAllActivitiesResponse, UpdateActivityData, UpdateActivityError, UpdateActivityResponse, CreateEntityData, CreateEntityError, CreateEntityResponse, UploadImageData, UploadImageError, UploadImageResponse, GetAllProcessorMapsError, GetAllProcessorMapsResponse, CreateProcessorMapData, CreateProcessorMapError, CreateProcessorMapResponse, CallbackData, CallbackError, CallbackResponse, CreateData, CreateError, CreateResponse, SupplyOrderData, SupplyOrderError, SupplyOrderResponse, RefundOrderData, RefundOrderError, RefundOrderResponse, CreateOrderInStoreData, CreateOrderInStoreError, CreateOrderInStoreResponse, LoginData, LoginError, LoginResponse, UploadImage1Data, UploadImage1Error, UploadImage1Response, GetUserByNameData, GetUserByNameError, GetUserByNameResponse, GetAllProductCatesShopError, GetAllProductCatesShopResponse, GetAllProductsShopError, GetAllProductsShopResponse, ExistsByCateIdData, ExistsByCateIdError, ExistsByCateIdResponse, GetAllOrdersData, GetAllOrdersError, GetAllOrdersResponse, GetOrdersByUserIdData, GetOrdersByUserIdError, GetOrdersByUserIdResponse, WxLoginOrRegisterData, WxLoginOrRegisterError, WxLoginOrRegisterResponse, ValidateError, ValidateResponse, GetAllActivitiesShopError, GetAllActivitiesShopResponse, DeleteFixDeliveryInfoData, DeleteFixDeliveryInfoError, DeleteFixDeliveryInfoResponse, DeleteCouponData, DeleteCouponError, DeleteCouponResponse } from './types.gen';
...
export const deleteCoupon = <ThrowOnError extends boolean = false>(options: Options<DeleteCouponData, ThrowOnError>) => { return (options?.client ?? client).delete<DeleteCouponResponse, DeleteCouponError, ThrowOnError>({
    ...options,
    url: '/coupon/{id}'
}); };