...
import type { GetAllUsersError, GetAllUsersResponse, UpdateUserData, UpdateUserError, UpdateUserResponse, CreateUserData, CreateUserError, CreateUserResponse, GetAllProductCatesError, GetAllProductCatesResponse, UpdateProductCateData, UpdateProductCateError, UpdateProductCateResponse, CreateProductCateData, CreateProductCateError, CreateProductCateResponse, GetAllProductsError, GetAllProductsResponse, UpdateProductData, UpdateProductError, UpdateProductResponse, CreateProductData, CreateProductError, CreateProductResponse, GetAllProductOptionsError, GetAllProductOptionsResponse, UpdateProductOptionData, UpdateProductOptionError, UpdateProductOptionResponse, CreateProductOptionData, CreateProductOptionError, CreateProductOptionResponse, GetAllPointsProductsError, GetAllPointsProductsResponse, UpdatePointsProductData, UpdatePointsProductError, UpdatePointsProductResponse, CreatePointsProductData, CreatePointsProductError, CreatePointsProductResponse, GetAllFixDeliveryInfosError, GetAllFixDeliveryInfosResponse, UpdateFixDeliveryInfoData, UpdateFixDeliveryInfoError, UpdateFixDeliveryInfoResponse, CreateFixDeliveryInfoData, CreateFixDeliveryInfoError, CreateFixDeliveryInfoResponse, GetAllCouponsError, GetAllCouponsResponse, UpdateCouponData, UpdateCouponError, UpdateCouponResponse, CreateCouponData, CreateCouponError, CreateCouponResponse, GetAllAppConfigurationsError, GetAllAppConfigurationsResponse, UpdateConfigurationData, UpdateConfigurationError, UpdateConfigurationResponse, AddConfigurationData, AddConfigurationError, AddConfigurationResponse, UpdateInventoryData, UpdateInventoryError, UpdateInventoryResponse, GetAllActivitiesError, GetAllActivitiesResponse, UpdateActivityData, UpdateActivityError, UpdateActivityResponse, CreateEntityData, CreateEntityError, CreateEntityResponse, UploadImageData, UploadImageError, UploadImageResponse, ReplenishProductData, ReplenishProductError, ReplenishProductResponse, GetAllProcessorMapsError, GetAllProcessorMapsResponse, CreateProcessorMapData, CreateProcessorMapError, CreateProcessorMapResponse, UploadImagePointsProductData, UploadImagePointsProductError, UploadImagePointsProductResponse, RedeemPointsProductData, RedeemPointsProductError, RedeemPointsProductResponse, SetPointsProductAsReceivedData, SetPointsProductAsReceivedError, SetPointsProductAsReceivedResponse, ExchangeCouponData, ExchangeCouponError, ExchangeCouponResponse, CallbackData, CallbackError, CallbackResponse, CreateData, CreateError, CreateResponse, SupplyOrderData, SupplyOrderError, SupplyOrderResponse, RefundCallbackData, RefundCallbackError, RefundCallbackResponse, RefundApplyData, RefundApplyError, RefundApplyResponse, CreateOrderInStoreData, CreateOrderInStoreError, CreateOrderInStoreResponse, BatchSupplyOrdersData, BatchSupplyOrdersError, BatchSupplyOrdersResponse, DistributeCouponToStudentsData, DistributeCouponToStudentsError, DistributeCouponToStudentsResponse, AddCouponToUserData, AddCouponToUserError, AddCouponToUserResponse, GetPhoneNumberData, GetPhoneNumberError, GetPhoneNumberResponse, CheckStudentIdentityData, CheckStudentIdentityError, CheckStudentIdentityResponse, LoginData, LoginError, LoginResponse, GetInventoryRecordsByTimePeriodData, GetInventoryRecordsByTimePeriodError, GetInventoryRecordsByTimePeriodResponse, InboundData, InboundError, InboundResponse, CreateInventoryData, CreateInventoryError, CreateInventoryResponse, CheckInventoryData, CheckInventoryError, CheckInventoryResponse, UploadImage1Data, UploadImage1Error, UploadImage1Response, GetUserByNameData, GetUserByNameError, GetUserByNameResponse, GetNewUsersData, GetNewUsersError, GetNewUsersResponse, GetUserDtoByIdData, GetUserDtoByIdError, GetUserDtoByIdResponse, GetAllProductCatesShopError, GetAllProductCatesShopResponse, GetAllProductsShopError, GetAllProductsShopResponse, ExistsByCateIdData, ExistsByCateIdError, ExistsByCateIdResponse, GetAllPointsProductsShopError, GetAllPointsProductsShopResponse, GetAllPointsProductInsError, GetAllPointsProductInsResponse, GetAllOrdersData, GetAllOrdersError, GetAllOrdersResponse, GetOrdersByUserIdData, GetOrdersByUserIdError, GetOrdersByUserIdResponse, GetOrdersByDeliveryInfoData, GetOrdersByDeliveryInfoError, GetOrdersByDeliveryInfoResponse, GetOrderByIdData, GetOrderByIdError, GetOrderByIdResponse, GetAllCouponsForPointsError, GetAllCouponsForPointsResponse, GetCouponInsOfAuserError, GetCouponInsOfAuserResponse, WxLoginOrRegisterData, WxLoginOrRegisterError, WxLoginOrRegisterResponse, ValidateError, ValidateResponse, GetTimeToStopOrderingError, GetTimeToStopOrderingResponse, GetOpeningTimeError, GetOpeningTimeResponse, GetOperationRecordsData, GetOperationRecordsError, GetOperationRecordsResponse, GetAllInventoriesError, GetAllInventoriesResponse, GetAllActivitiesShopError, GetAllActivitiesShopResponse, DeleteProductOptionData, DeleteProductOptionError, DeleteProductOptionResponse, DeleteFixDeliveryInfoData, DeleteFixDeliveryInfoError, DeleteFixDeliveryInfoResponse, DeleteConfigurationData, DeleteConfigurationError, DeleteConfigurationResponse } from './types.gen';
...
export const updateInventory = <ThrowOnError extends boolean = false>(options: Options<UpdateInventoryData, ThrowOnError>) => { return (options?.client ?? client).put<UpdateInventoryResponse, UpdateInventoryError, ThrowOnError>({
    ...options,
 ...
 * 补货接口，更新商品库存信息
 */
export const replenishProduct = <ThrowOnError extends boolean = false>(options: Options<ReplenishProductData, ThrowOnError>) => { return (options?.client ?? client).post<ReplenishProductResponse, ReplenishProductError, ThrowOnError>({
    ...options,
    url: '/product/replenish'
}); };
...
/**
 * 创建预支付订单。小程序先调用这个，再调用wx.requestPayment。response包含了调起支付所需的所有参数，可直接用于前端调起支付
...
/**
 * 接收退款结果通知。是腾讯的微信支付系统调用的
 */
export const refundCallback = <ThrowOnError extends boolean = false>(options: Options<RefundCallbackData, ThrowOnError>) => { return (options?.client ?? client).post<RefundCallbackResponse, RefundCallbackError, ThrowOnError>({
    ...options,
    url: '/order/refund_callback'
}); };

export const refundApply = <ThrowOnError extends boolean = false>(options: Options<RefundApplyData, ThrowOnError>) => { return (options?.client ?? client).post<RefundApplyResponse, RefundApplyError, ThrowOnError>({
    ...options,
    url: '/order/refund_apply'
}); };
...
export const batchSupplyOrders = <ThrowOnError extends boolean = false>(options: Options<BatchSupplyOrdersData, ThrowOnError>) => { return (options?.client ?? client).post<BatchSupplyOrdersResponse, BatchSupplyOrdersError, ThrowOnError>({
    ...options,
    url: '/order/batchSupply'
}); };

/**
 * 给所有认证为学生的用户发放优惠券，商铺端专用
 */
export const distributeCouponToStudents = <ThrowOnError extends boolean = false>(options: Options<DistributeCouponToStudentsData, ThrowOnError>) => { return (options?.client ?? client).post<DistributeCouponToStudentsResponse, DistributeCouponToStudentsError, ThrowOnError>({
    ...options,
    url: '/coupon/distribute_coupon_to_students'
}); };
 ...
 */
export const getPhoneNumber = <ThrowOnError extends boolean = false>(options: Options<GetPhoneNumberData, ThrowOnError>) => { return (options?.client ?? client).post<GetPhoneNumberResponse, GetPhoneNumberError, ThrowOnError>({
    ...options,
...
export const getInventoryRecordsByTimePeriod = <ThrowOnError extends boolean = false>(options: Options<GetInventoryRecordsByTimePeriodData, ThrowOnError>) => { return (options?.client ?? client).post<GetInventoryRecordsByTimePeriodResponse, GetInventoryRecordsByTimePeriodError, ThrowOnError>({
    ...options,
    url: '/api/inventory/records/time-period'
}); };

export const inbound = <ThrowOnError extends boolean = false>(options: Options<InboundData, ThrowOnError>) => { return (options?.client ?? client).post<InboundResponse, InboundError, ThrowOnError>({
    ...options,
    url: '/api/inventory/inbound'
}); };

export const createInventory = <ThrowOnError extends boolean = false>(options: Options<CreateInventoryData, ThrowOnError>) => { return (options?.client ?? client).post<CreateInventoryResponse, CreateInventoryError, ThrowOnError>({
    ...options,
    url: '/api/inventory/create'
}); };

export const checkInventory = <ThrowOnError extends boolean = false>(options: Options<CheckInventoryData, ThrowOnError>) => { return (options?.client ?? client).post<CheckInventoryResponse, CheckInventoryError, ThrowOnError>({
    ...options,
...
/**
 * 根据userId查询用户信息，结果为UserDTO
 */
export const getUserDtoById = <ThrowOnError extends boolean = false>(options: Options<GetUserDtoByIdData, ThrowOnError>) => { return (options?.client ?? client).get<GetUserDtoByIdResponse, GetUserDtoByIdError, ThrowOnError>({
    ...options,
    url: '/user/dto/{id}'
}); };
...
/**
 * 根据userId查询Orders，当前端传递all=true时，返回所有，否则默认10条
 */
...
export const getOrdersByDeliveryInfo = <ThrowOnError extends boolean = false>(options: Options<GetOrdersByDeliveryInfoData, ThrowOnError>) => { return (options?.client ?? client).get<GetOrdersByDeliveryInfoResponse, GetOrdersByDeliveryInfoError, ThrowOnError>({
    ...options,
    url: '/order/getOrdersByDeliveryInfo'
}); };

export const getOrderById = <ThrowOnError extends boolean = false>(options: Options<GetOrderByIdData, ThrowOnError>) => { return (options?.client ?? client).get<GetOrderByIdResponse, GetOrderByIdError, ThrowOnError>({
    ...options,
    url: '/order/getById'
}); };
 ...
 * 获取当前用户的所有优惠券实例
 */
export const getCouponInsOfAuser = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<GetCouponInsOfAuserResponse, GetCouponInsOfAuserError, ThrowOnError>({
    ...options,
    url: '/coupon/current_user'
}); };
 ...
 * 定时达截至下单时间间隔，单位：分钟。
 */
export const getTimeToStopOrdering = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<GetTimeToStopOrderingResponse, GetTimeToStopOrderingError, ThrowOnError>({
    ...options,
    url: '/appConfiguration/timeToStopOrdering'
}); };

/**
 * 获取营业时间
 */
export const getOpeningTime = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<GetOpeningTimeResponse, GetOpeningTimeError, ThrowOnError>({
    ...options,
    url: '/appConfiguration/openingTime'
}); };

export const getOperationRecords = <ThrowOnError extends boolean = false>(options: Options<GetOperationRecordsData, ThrowOnError>) => { return (options?.client ?? client).get<GetOperationRecordsResponse, GetOperationRecordsError, ThrowOnError>({
    ...options,
    url: '/api/inventory/{id}/records'
}); };

export const getAllInventories = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => { return (options?.client ?? client).get<GetAllInventoriesResponse, GetAllInventoriesError, ThrowOnError>({
    ...options,
...
export const deleteProductOption = <ThrowOnError extends boolean = false>(options: Options<DeleteProductOptionData, ThrowOnError>) => { return (options?.client ?? client).delete<DeleteProductOptionResponse, DeleteProductOptionError, ThrowOnError>({
    ...options,
